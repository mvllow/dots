...
# Warning, this script is a WIP and not filling it's intended purpose. Check back soon!

# This script is meant for fresh installs of macOS.
# Settings are opionated, and there are no confirmations.
# It is highly recommended to fork this and edit the _TODO_ comments.
